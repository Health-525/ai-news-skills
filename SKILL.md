...
Read [references/on-demand-transcript.md](references/on-demand-transcript.md).

- Use this route only when an authenticated member explicitly asks in the configured Feishu group
